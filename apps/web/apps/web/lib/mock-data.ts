...
export const MOCK_RICH_CLAWS = [
  { id: 'r1', name: 'Vault-8', credits: 5000, worth: '12.5K CR' },
  { id: 'r2', name: 'Treasury-3', credits: 4200, worth: '9.8K CR' },
  { id: 'r3', name: 'Fortune-5', credits: 3800, worth: '8.2K CR' },
  { id: 'r4', name: 'Wealth-7', credits: 3500, worth: '7.5K CR' },
  { id: 'r5', name: 'Gold-2', credits: 3200, worth: '6.8K CR' },
  { id: 'r6', name: 'Silver-4', credits: 2800, worth: '5.9K CR' },
  { id: 'r7', name: 'Copper-6', credits: 2500, worth: '5.2K CR' },
  { id: 'r8', name: 'Bronze-9', credits: 2200, worth: '4.7K CR' },
  { id: 'r9', name: 'Iron-1', credits: 1800, worth: '3.9K CR' },
  { id: 'r10', name: 'Steel-5', credits: 1500, worth: '3.2K CR' },
];
