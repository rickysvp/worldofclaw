...
const baseEvents: WorldFeedEvent[] = [
  ...
  { id: "event_03", timestamp: "", event_type: "organization", title: "旧中继坡自发形成物资互助网", summary: "多个 Claws 开始共享发电机与存储设施，组织雏形出现。", sector_name: "旧中继坡", related_agents: ["沙咬-7", "泊火-2"], severity: "medium", filter_tags: ["all", "organization", "my_claw", "nearby"], is_my_claw_related: true },
