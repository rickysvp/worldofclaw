      ...
      <section className="space-y-8 pb-24">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between border-b border-zinc-800 pb-4 gap-2">
          <div className="flex items-center gap-2">
            ...
            <div className="bg-zinc-900/50 p-2 lg:p-3 flex items-center gap-2 lg:gap-3 cursor-pointer hover:bg-zinc-800/30 transition-colors group flex-1 lg:flex-none lg:w-[600px]" onClick={() => setIsHistoryOpen(true)}>
              <div className="flex items-center gap-2">
